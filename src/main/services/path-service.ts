...
import { Project, projectTypes } from '../../shared/types/project';
import {
    catchError,
    filter,
    map,
...
import { reportException } from './error-service';
import { setChildren } from './project-service';
...
export function scanPathAndUpdateDatabase(
    ...
    const filteredPatterns$ = getSetting('FILTERED_PATTERNS');
